...
const navLinkStyle: React.CSSProperties = {
 ...
 <div
  className="h-9 w-9 shrink-0 rounded-xl border grid place-items-center font-semibold transition hover:-translate-y-0.5"
  style={{
    borderColor: "rgba(96,165,250,0.35)",
    background:
      "linear-gradient(135deg, rgba(96,165,250,0.18), rgba(167,139,250,0.12))",
    boxShadow: "0 0 24px rgba(96,165,250,0.10)",
  }}
>
  SG
</div>
...
<div className="hidden sm:block leading-tight min-w-0">
  <div className="text-sm font-semibold truncate">Santiago Gretter</div>
  <div
...
<MobileMenu
  ...
  labels={{
    name: i.name,
    role: i.brandSubtitle,
    services: i.navServices,
projects: i.navProjects,
    commercial: i.navCommercial,
    process: i.navProcess,
    experience: i.navExperience,
    contact: i.navContact,
